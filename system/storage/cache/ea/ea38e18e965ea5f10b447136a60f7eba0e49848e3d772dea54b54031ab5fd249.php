...
class __TwigTemplate_6132bcc5d03b1eab17f916f4b016df18f76f080262130bfe69ca81884e7fc749 extends Twig_Template
{
...
/*               <label class="col-sm-2 control-label" for="{{ id }}-{{ index }}">{{ item.label }}</label>*/
/*               <div class="col-sm-10">*/
/*                 <input type="text" name="item[{{ index }}]" value="" placeholder="{{ item.label }}" id="{{ id }}-{{ index }}" class="form-control"/>*/
/*               </div>*/
/*             </div>*/
/*           {% endif %}*/
/* */
...
/*               <label class="col-sm-2 control-label" for="{{ id }}-{{ index }}">{{ item.label }}</label>*/
/*               <div class="col-sm-10">*/
/*                 <input type="email" name="item[{{ index }}]" value="" placeholder="{{ item.label }}" id="{{ id }}-{{ index }}" class="form-control"/>*/
/*               </div>*/
/*             </div>*/
/*           {% endif %}*/
/* */
...
/*               <label class="col-sm-2 control-label" for="{{ id }}-{{ index }}">{{ item.label }}</label>*/
/*               <div class="col-sm-10">*/
/*                 <input type="tel" name="item[{{ index }}]" value="" placeholder="{{ item.label }}" id="{{ id }}-{{ index }}" class="form-control"/>*/
/*               </div>*/
/*             </div>*/
/*           {% endif %}*/
/* */
...
/*               <label class="col-sm-2 control-label" for="{{ id }}-{{ index }}">{{ item.label }}</label>*/
/*               <div class="col-sm-10">*/
/*                 <textarea name="item[{{ index }}]" rows="5" placeholder="{{ item.label }}" id="{{ id }}-{{ index }}" class="form-control"></textarea>*/
/*               </div>*/
/*             </div>*/
/*           {% endif %}*/
/* */
