...
class __TwigTemplate_11511134b52806e1b639349ad7d47301c6c96f332ead45ce555a3d688d623561 extends Twig_Template
{
...
/*         {% if 0 %}*/
/*           <img src="{{ context.dummy_image }}" data-src="{{ item.image }}" {% if item.image2x %}data-srcset="{{ item.image }} 1x, {{ item.image2x }} 2x" {% endif %} alt="{{ item.title }}" width="{{ context.imageDimensions.width }}" height="{{ context.imageDimensions.height }}" class="lazyload"/>*/
/*         {% else %}*/
/*           <img src="{{ item.image }}" {% if item.image2x %}srcset="{{ item.image }} 1x, {{ item.image2x }} 2x" {% endif %} alt="{{ item.title }}" width="{{ context.imageDimensions.width }}" height="{{ context.imageDimensions.height }}"/>*/
/*         {% endif %}*/
/*         {% if item.title %}*/
